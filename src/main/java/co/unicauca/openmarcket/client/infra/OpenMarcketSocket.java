package co.unicauca.openmarcket.client.infra;
 ...
 */
public class OpenMarcketSocket {
    ...
    public String sendRequest(String requestJson) throws IOException {
        ...
        Logger.getLogger(OpenMarcketSocket.class.getName()).log(Level.INFO, "Lo que se le envia al: ("+requestJson+")");
        ...
        Logger.getLogger(OpenMarcketSocket.class.getName()).log(Level.INFO, "Lo que se lee del servidor: ("+response+")");
    ...
    public void disconnect() {
        ...
        try {
            ...
            Logger.getLogger(OpenMarcketSocket.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
