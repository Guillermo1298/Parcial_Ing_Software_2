...
import static co.unicauca.openmarcket.client.infra.Messages.warningMessage;
...
public class GUIMenu extends javax.swing.JFrame {
    ...
    private void ponerUsuarioLogueado() {
        ...
        if (co.unicauca.openmarcket.client.infra.Security.usuario == null) {
            this.mnuEmpleadoLogueado.setText("(Anónimo)");
        } else {
            this.mnuEmpleadoLogueado.setText("(" + co.unicauca.openmarcket.client.infra.Security.usuario.getLogin() + ")");
        }
    ...
    private void initComponents() {
        ...
        mnuConsultarClientes.setText("Gestión de Productos");
